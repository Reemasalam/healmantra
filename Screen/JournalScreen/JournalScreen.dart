...
class _JournalScreenState extends State<JournalScreen> {
  ...
  onPressed: () {
    if (journalEntryController.text.isNotEmpty) {
      ...
      _addJournalEntryToFirestore(_selectedDay, journalEntryController.text);
    }
    Navigator.of(context).pop();
  },
),
...
Future<void> _addJournalEntryToFirestore(DateTime date, String entry) async {
    try {
      ...
      print('Error adding journal entry to Firestore: $e');
    }
  }
  @override
